...
export function Avatar({ visemeData, ...props }) {
  ...
  // }, []);
   ...
   // State to handle blinking animation
   const [blink, setBlink] = useState(false);

   useEffect(() => {
     // Simulate blinking every 4-6 seconds
     const blinkInterval = setInterval(() => {
       setBlink(true);
       setTimeout(() => setBlink(false), 150); // Blink duration of 150ms
     }, Math.random() * 2000 + 4000); // Random interval between 4 and 6 seconds
  ...
  useFrame(() => {
    if (visemeData && visemeData.viseme) {
      ...
      if (visemeIndex !== undefined) {
        nodes.Wolf3D_Head.morphTargetInfluences[visemeIndex] = 0.12;
        nodes.Wolf3D_Teeth.morphTargetInfluences[visemeTeethIndex] = 0.7;
        nodes.Wolf3D_Beard.morphTargetInfluences[visemeBeardIndex] = 0.18;
